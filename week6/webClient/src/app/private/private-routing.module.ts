...
// import {PlottingExampleComponent} from "./plotting-example/plotting-example.component";
import {ChartsRootComponent} from "../charts/charts-root/charts-root.component";
...
const privateRoutes: Routes = [
  {
    ...
    children: [
      ...
      // {path: 'plottingexamples', component: PlottingExampleComponent},
      {path: 'plottingexamples', component: ChartsRootComponent},
